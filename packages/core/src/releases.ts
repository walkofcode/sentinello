...
export const RELEASE_COPY: Record<Locale, Record<string, ReleaseCopy>> = {
    en: {
        '3.2.1': {
            title: 'Advisory version ranges keep their exact bounds',
            items: [
    ...
    es: {
        '3.2.1': {
            title: 'Los rangos de versiones de los avisos conservan sus límites exactos',
            items: [
    ...
    fr: {
        '3.2.1': {
            title: 'Les plages de versions des avis conservent leurs bornes exactes',
            items: [
    ...
    de: {
        '3.2.1': {
            title: 'Versionsbereiche von Advisories behalten ihre exakten Grenzen',
            items: [
    ...
    'pt-BR': {
        '3.2.1': {
            title: 'Os intervalos de versão dos avisos mantêm seus limites exatos',
            items: [
    ...
    it: {
        '3.2.1': {
            title: 'Gli intervalli di versione degli advisory mantengono i limiti esatti',
            items: [
    ...
    ja: {
        '3.2.1': {
            title: 'アドバイザリのバージョン範囲が境界どおりに扱われます',
            items: [
    ...
    ko: {
        '3.2.1': {
            title: '권고의 버전 범위가 정확한 경계를 유지합니다',
            items: [
    ...
    ru: {
        '3.2.1': {
            title: 'Диапазоны версий в рекомендациях сохраняют точные границы',
            items: [
