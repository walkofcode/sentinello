...
export default async function Terms() {
    ...
    return (
        <div className="flex flex-col min-h-screen legal">
            ...
            <h3 className="text-xl font-bold">Your Right to Post Content</h3>
            <p>
            ...
            <p>
                ...
                on and through the Service. You retain any and all of Your rights to any Content You
            ...
            <p>
                ...
                the right to use it and grant Us the rights and license as provided in these Terms,
                and (ii) the posting of Your Content on or through the Service does not violate the
                privacy rights, publicity rights, copyrights, contract rights or any other rights of
                any person.
            </p>
            <h3 className="text-xl font-bold">Content Restrictions</h3>
            <p>
            ...
            <p>
                ...
                Examples of such objectionable Content include, but are not limited to, the
                following:
            </p>
            <ul>
            ...
            <p>
                ...
                formatting and edits and change the manner of any Content. The Company can also
                limit or revoke the use of the Service if You post such objectionable Content. As
                the Company cannot control all content posted by users and/or third parties on the
                Service, you agree to use the Service at your own risk. You understand that by using
                the Service You may be exposed to content that You may find offensive, indecent,
                incorrect or objectionable, and You agree that under no circumstances will the
                Company be liable in any way for any content, including any errors or omissions in
                any content, or any loss or damage of any kind incurred as a result of your use of
                any content.
            </p>
            <h3 className="text-xl font-bold">Content Backups</h3>
            <p>
            ...
            <p>
                Corrupt or invalid backup points may be caused by, without limitation, Content that
                is corrupted prior to being backed up or that changes during the time a backup is
                performed.
            </p>
            <p>
                ...
                has no liability related to the integrity of Content or the failure to successfully
            ...
            <h2 className="text-2xl font-bold">Copyright Policy</h2>
            <h3 className="text-xl font-bold">Intellectual Property Infringement</h3>
            <p>
            ...
            <p>
                ...
                infringement that is taking place through the Service, You must submit Your notice
                in writing to the attention of our copyright agent via email at{' '}
                <a href="mailto:info@sentinello.org">info@sentinello.org</a>{' '}
            ...
            <p>
                ...
                discretion, it deems appropriate, including removal of the challenged content from
                the Service.
            </p>
