...
export default async function Disclaimer() {
    ...
    return (
        <div className="flex flex-col legal">
            <h1 className="text-3xl font-bold">{t('disclaimerTitle')}</h1>
            ...
            <ul>
                <li>
                    ...
                    Walk of Code LLC, 4030 WAKE FOREST RD STE 349.
                </li>
                <li>
                    <strong>Service</strong> refers to the Website.
                </li>
                <li>
                    <strong>You</strong> means the individual accessing the Service, or the company,
            ...
            <h2 className="text-2xl font-bold">Errors and Omissions Disclaimer</h2>
            <p>
            ...
            <p>
                If You wish to use copyrighted material from the Service for your own purposes that
                go beyond fair use, You must obtain permission from the copyright owner.
            </p>
            <h2 className="text-2xl font-bold">No Responsibility Disclaimer</h2>
            <p>
                The information on the Service is provided with the understanding that the Company
                is not herein engaged in rendering legal, accounting, tax, or other professional
                advice and services. As such, it should not be used as a substitute for consultation
                with professional accounting, tax, legal or other competent advisers.
            </p>
            <p>
            ...
            <h2 className="text-2xl font-bold">&quot;Use at Your Own Risk&quot; Disclaimer</h2>
            <p>
